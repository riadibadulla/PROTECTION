...
def filter_data_by_model_with_marabou(model, data_loader, low_thresh=0.25, high_thresh=0.65, perturbation=0.01):
    # onnx save
    ...
    with torch.no_grad():
        ...
        for features, _ in progress_bar:
            for data_point in features:
                ...
                mask.append(bool(solve_result[0]))  # True if valid
